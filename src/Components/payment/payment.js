                ...
                <Container fluid>
                    ...
                    <Row padding>
                        ...
                        <Col md={8} lg={4} sm={8} xs={8} className="button1">
                            ...
                            <Link to="/shop" className="opt1">Back To Store</Link>
                        ...
                        <Col md={8} lg={4} sm={8} xs={8} className="button2">
                            ...
                            <Link to="/users/cart/check-out" className="opt2" disabled={itemIncart.length > 0 ? false : true} onClick={() => handleCheckOut()}>Check Out</Link>
